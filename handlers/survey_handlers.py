            ...
            if not data.get('start_date'):
                ...
                if data.get('last_command') in ('lowprice', 'highprice'):
                    ...
                    bot.send_message(call.message.chat.id,
                                     f"Поиск Завершен 🎉 Спасибо! Благодарю 👏 за то, что использовали Бота.\n"
                                     f"Вы также можете выбрать другую команду для поиска 🤔\n"
                                     f"Команды! 💡 Например: <b>/help</b>", parse_mode="html")
                else:
