...
def bot_best_deal(message: Message):
    ...
    Записывает состояние пользователя 'last_command' и предлагает ввести количество взрослых, детей и их возраст (если есть).
...
def set_children_count(message: Message):
    """
...
def set_children_age(message: Message):
    """
