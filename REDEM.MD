# Скрипт для Telegram-бота, написанный на библиотеке Telebot. Это бот по аренде машин, позволяющий пользователям бронировать автомобили. Вот подробное описание скрипта:
