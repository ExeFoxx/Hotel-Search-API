...
def handle_instagram_button(message):
    bot.send_message(message.chat.id, "Приветствую вас, пользоваться мной очень легко и быстро, если нажать  на  кнопку *Оставить Заявку🚗* то вы сможете бысто  выбрать машину, и наш менеджер с вами свяжется!!! ")
...
def get_first_name(message):
    if message.text != 'Оставить Заявку🚗':
        bot.send_message(message.chat.id, 'Ошибка! Пожалуйста, введите команду "Оставить Заявку🚗"')
        return
    user_data['first_name'] = ''
    bot.send_message(message.chat.id, 'Пожалуйста, введите свое Имя для заявки на Бронь Машины:')
